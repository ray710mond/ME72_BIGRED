...
class PWMReader:
    ...
    def read(self):
        ...
        """
        if not self.line.event_wait(0):  # 0-sec timeout: just poll
        ...
        elif event.type == gpiod.LineEvent.FALLING_EDGE and self.last_rise is not None:
            pw_us = (ts - self.last_rise) * 1e6
...
def main():
    ...
    try:
        while True:
            ...
            # Debug print
            print(
                f"thr_pw={throttle_pw}, steer_pw={steer_pw}, "
